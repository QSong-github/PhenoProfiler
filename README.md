...
The phenotype correction strategy processed features are obtained by executing the corresponding ipynb file [Phenotype correction strategy.ipynb.ipynb](Phenotype_correction_strategy.ipynb). 
